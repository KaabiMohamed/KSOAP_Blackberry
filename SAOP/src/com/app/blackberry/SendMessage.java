...
public class SendMessage extends MainScreen {
	...
	BasicEditField object, message, date, receptorLogin;
	String senderL;

	public SendMessage(String senderLogin) {
		
		senderL = senderLogin;
		receptorLogin = new BasicEditField("To :", "");
		object = new BasicEditField("Object : ", "");
		message = new BasicEditField("Message :", "");
